 ...
 *
 * 複数スレッドが複数のファイルからすべての単語を読み込むアプリケーショ ンを書きなさい。各単語がどのファイルで使用されていたかを管理するために
 * ConcurrentHashMap<String, Set<File>>を使用しなさい。マップを更新する ために、merge メソッドを使用しなさい。
 */
public class ParallelWordIndexing {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Logger.getLogger(ParallelWordIndexing.class.getName()).log(Level.SEVERE, null, ex);
        }
